    ...
    <div className="flex h-screen overflow-hidden">
      ...
      >
        <div className="flex items-center justify-between px-5 py-8">
          <span
            onClick={() => navigate("/")}
            className="text-xl text-gray-800 font-bold flex items-center gap-2 cursor-pointer"
          >
            <img src="./wallet-icon.svg" alt="" className="size-8" /> WalletPal
          </span>
          <button
            ref={toggleRef}
            className="md:hidden"
      ...
      <div className="flex-1 flex flex-col h-full">
        ...
        <main className="p-6 bg-blue-50 flex-1 overflow-y-auto">
