  ...
  return (
    <>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
        ...
        <MoneyCard title={"Total Spent"} amount={budgetUsage.total.totalSpent} icon={"-"} style={"text-red-500"} textColor="text-red-500" />
        <MoneyCard title={"Remaining"} textColor={budgetUsage.total.totalSpent >= 0 ? "text-gray-1000" : "text-red-500"}
